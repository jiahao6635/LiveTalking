...
from ttsreal import EdgeTTS,SovitsTTS,XTTS,CosyVoiceTTS,FishTTS,TencentTTS,DoubaoTTS,IndexTTS2,AzureTTS,BailianCosyVoiceTTS
...
class BaseReal:
    def __init__(self, opt):
        ...
        elif opt.tts == "bailian-cosyvoice":
            self.tts = BailianCosyVoiceTTS(opt,self)
